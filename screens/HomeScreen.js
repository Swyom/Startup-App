...
const VENDORS = [
  {
    ...
    description:
      "Specializing in breathtaking, high-end editorial flora arrangements tailored for luxury boutique weddings and milestone celebrations.",
  },
  {
    id: "2",
    ...
    rating: 5.0,
    image:
      "https://images.unsplash.com/photo-1537633552985-df8429e8048b?q=80&w=500",
    location: "Brooklyn, NY",
    description:
      "Capturing timeless, cinematic visual love stories with fine-art film aesthetics and bespoke editorial portrait curation.",
  },
  {
    id: "3",
    ...
    rating: 4.6,
    image:
      "https://images.unsplash.com/photo-1555244162-803834f70033?q=80&w=500",
    location: "Boutique Global",
    description:
      "Curating world-class sensory gastronomy profiles, bespoke tasting pairing modules, and uncompromised white-glove table execution.",
  },
];
